...
static void vertical_ctrl_agl_cb(uint8_t sender_id __attribute__((unused)), uint32_t __attribute__((unused)) stamp, float distance);
...
static void vertical_ctrl_agl_cb(uint8_t sender_id, uint32_t __attribute__((unused)) stamp, float distance)
{
  v_ctrl.agl = distance;
}
