...
#define VAL_GPIOA_MODER                 (PIN_MODE_ALTERNATE(UART4_TX) | \
					 ...
					 PIN_MODE_ALTERNATE(MPULS5_TIM3_CH1) | \
					 PIN_MODE_ALTERNATE(MPULS6_TIM3_CH2) | \
					 PIN_MODE_ALTERNATE(SERVO4_TIM1_CH1) | \
					 PIN_MODE_ALTERNATE(SERVO2_TIM1_CH2) | \
					 PIN_MODE_ALTERNATE(SERVO3_TIM1_CH3) | \
					 PIN_MODE_ALTERNATE(SERVO1_TIM1_CH4) | \
...
#define VAL_GPIOA_OTYPER                (PIN_OTYPE_PUSHPULL(UART4_TX) | \
					 ...
					 PIN_OTYPE_PUSHPULL(MPULS5_TIM3_CH1) | \
					 PIN_OTYPE_PUSHPULL(MPULS6_TIM3_CH2) | \
					 PIN_OTYPE_PUSHPULL(SERVO4_TIM1_CH1) | \
					 PIN_OTYPE_PUSHPULL(SERVO2_TIM1_CH2) | \
					 PIN_OTYPE_PUSHPULL(SERVO3_TIM1_CH3) | \
					 PIN_OTYPE_PUSHPULL(SERVO1_TIM1_CH4) | \
...
#define VAL_GPIOA_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(UART4_TX) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(MPULS5_TIM3_CH1) | \
					 PIN_OSPEED_SPEED_HIGH(MPULS6_TIM3_CH2) | \
					 PIN_OSPEED_SPEED_HIGH(SERVO4_TIM1_CH1) | \
					 PIN_OSPEED_SPEED_HIGH(SERVO2_TIM1_CH2) | \
					 PIN_OSPEED_SPEED_HIGH(SERVO3_TIM1_CH3) | \
					 PIN_OSPEED_SPEED_HIGH(SERVO1_TIM1_CH4) | \
...
#define VAL_GPIOA_PUPDR                 (PIN_PUPDR_FLOATING(UART4_TX) | \
					 ...
					 PIN_PUPDR_FLOATING(MPULS5_TIM3_CH1) | \
					 PIN_PUPDR_FLOATING(MPULS6_TIM3_CH2) | \
					 PIN_PUPDR_FLOATING(SERVO4_TIM1_CH1) | \
					 PIN_PUPDR_FLOATING(SERVO2_TIM1_CH2) | \
					 PIN_PUPDR_FLOATING(SERVO3_TIM1_CH3) | \
					 PIN_PUPDR_FLOATING(SERVO1_TIM1_CH4) | \
...
#define VAL_GPIOA_ODR                   (PIN_ODR_LEVEL_HIGH(UART4_TX) | \
					 ...
					 PIN_ODR_LEVEL_LOW(MPULS5_TIM3_CH1) | \
					 PIN_ODR_LEVEL_LOW(MPULS6_TIM3_CH2) | \
					 PIN_ODR_LEVEL_LOW(SERVO4_TIM1_CH1) | \
					 PIN_ODR_LEVEL_LOW(SERVO2_TIM1_CH2) | \
					 PIN_ODR_LEVEL_LOW(SERVO3_TIM1_CH3) | \
					 PIN_ODR_LEVEL_LOW(SERVO1_TIM1_CH4) | \
...
#define VAL_GPIOA_AFRL			(PIN_AFIO_AF(UART4_TX, 8) | \
					 ...
					 PIN_AFIO_AF(MPULS5_TIM3_CH1, 2) | \
					 PIN_AFIO_AF(MPULS6_TIM3_CH2, 2))

#define VAL_GPIOA_AFRH			(PIN_AFIO_AF(SERVO4_TIM1_CH1, 1) | \
					 PIN_AFIO_AF(SERVO2_TIM1_CH2, 1) | \
					 PIN_AFIO_AF(SERVO3_TIM1_CH3, 1) | \
					 PIN_AFIO_AF(SERVO1_TIM1_CH4, 1) | \
					 PIN_AFIO_AF(USB_DP, 0) | \
					 PIN_AFIO_AF(SWDIO, 0) | \
					 PIN_AFIO_AF(SWCLK, 0) | \
					 PIN_AFIO_AF(SPI1_CS, 0))

#define VAL_GPIOB_MODER                 (PIN_MODE_ALTERNATE(MPULS3_TIM3_CH3) | \
					 PIN_MODE_ALTERNATE(MPULS4_TIM3_CH4) | \
					 ...
					 PIN_MODE_ALTERNATE(MPULS1_TIM2_CH3) | \
					 PIN_MODE_ALTERNATE(MPULS2_TIM2_CH4) | \
					 PIN_MODE_OUTPUT(SPI2_CS) | \
					 PIN_MODE_INPUT(NC1) | \
					 PIN_MODE_INPUT(PB14) | \
					 PIN_MODE_INPUT(PB15))

#define VAL_GPIOB_OTYPER                (PIN_OTYPE_PUSHPULL(MPULS3_TIM3_CH3) | \
					 PIN_OTYPE_PUSHPULL(MPULS4_TIM3_CH4) | \
					 ...
					 PIN_OTYPE_PUSHPULL(MPULS1_TIM2_CH3) | \
					 PIN_OTYPE_PUSHPULL(MPULS2_TIM2_CH4) | \
					 PIN_OTYPE_PUSHPULL(SPI2_CS) | \
					 PIN_OTYPE_OPENDRAIN(NC1) | \
					 PIN_OTYPE_PUSHPULL(PB14) | \
					 PIN_OTYPE_PUSHPULL(PB15))

#define VAL_GPIOB_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(MPULS3_TIM3_CH3) | \
					 PIN_OSPEED_SPEED_HIGH(MPULS4_TIM3_CH4) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(MPULS1_TIM2_CH3) | \
					 PIN_OSPEED_SPEED_HIGH(MPULS2_TIM2_CH4) | \
					 PIN_OSPEED_SPEED_HIGH(SPI2_CS) | \
					 PIN_OSPEED_SPEED_VERYLOW(NC1) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB14) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB15))

#define VAL_GPIOB_PUPDR                 (PIN_PUPDR_FLOATING(MPULS3_TIM3_CH3) | \
					 PIN_PUPDR_FLOATING(MPULS4_TIM3_CH4) | \
					 ...
					 PIN_PUPDR_FLOATING(MPULS1_TIM2_CH3) | \
					 PIN_PUPDR_FLOATING(MPULS2_TIM2_CH4) | \
					 PIN_PUPDR_FLOATING(SPI2_CS) | \
					 PIN_PUPDR_PULLDOWN(NC1) | \
					 PIN_PUPDR_PULLDOWN(PB14) | \
					 PIN_PUPDR_PULLDOWN(PB15))

#define VAL_GPIOB_ODR                   (PIN_ODR_LEVEL_LOW(MPULS3_TIM3_CH3) | \
					 PIN_ODR_LEVEL_LOW(MPULS4_TIM3_CH4) | \
					 ...
					 PIN_ODR_LEVEL_LOW(MPULS1_TIM2_CH3) | \
					 PIN_ODR_LEVEL_LOW(MPULS2_TIM2_CH4) | \
					 PIN_ODR_LEVEL_HIGH(SPI2_CS) | \
					 PIN_ODR_LEVEL_HIGH(NC1) | \
					 PIN_ODR_LEVEL_LOW(PB14) | \
					 PIN_ODR_LEVEL_LOW(PB15))

#define VAL_GPIOB_AFRL			(PIN_AFIO_AF(MPULS3_TIM3_CH3, 2) | \
					 PIN_AFIO_AF(MPULS4_TIM3_CH4, 2) | \
...
#define VAL_GPIOB_AFRH			(PIN_AFIO_AF(I2C1_SCL, 4) | \
					 ...
					 PIN_AFIO_AF(MPULS1_TIM2_CH3, 1) | \
					 PIN_AFIO_AF(MPULS2_TIM2_CH4, 1) | \
...
#define VAL_GPIOD_MODER                 (PIN_MODE_INPUT(NC4) | \
					 ...
					 PIN_MODE_ALTERNATE(SERVO6_TIM4_CH3) | \
					 PIN_MODE_ALTERNATE(SERVO5_TIM4_CH4))
...
#define VAL_GPIOD_OTYPER                (PIN_OTYPE_OPENDRAIN(NC4) | \
					 ...
					 PIN_OTYPE_PUSHPULL(SERVO6_TIM4_CH3) | \
					 PIN_OTYPE_PUSHPULL(SERVO5_TIM4_CH4))
...
#define VAL_GPIOD_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(NC4) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(SERVO6_TIM4_CH3) | \
					 PIN_OSPEED_SPEED_HIGH(SERVO5_TIM4_CH4))
...
#define VAL_GPIOD_PUPDR                 (PIN_PUPDR_PULLDOWN(NC4) | \
					 ...
					 PIN_PUPDR_FLOATING(SERVO6_TIM4_CH3) | \
					 PIN_PUPDR_FLOATING(SERVO5_TIM4_CH4))
...
#define VAL_GPIOD_ODR                   (PIN_ODR_LEVEL_HIGH(NC4) | \
					 ...
					 PIN_ODR_LEVEL_LOW(SERVO6_TIM4_CH3) | \
					 PIN_ODR_LEVEL_LOW(SERVO5_TIM4_CH4))
...
#define VAL_GPIOD_AFRH			(PIN_AFIO_AF(USART3_TX, 0) | \
					 ...
					 PIN_AFIO_AF(SERVO6_TIM4_CH3, 2) | \
					 PIN_AFIO_AF(SERVO5_TIM4_CH4, 2))
...
#define AF_MPULS5_TIM3_CH1               2U
#define AF_LINE_MPULS5_TIM3_CH1          2U
#define AF_MPULS6_TIM3_CH2               2U
#define AF_LINE_MPULS6_TIM3_CH2          2U
#define AF_SERVO4_TIM1_CH1               1U
#define AF_LINE_SERVO4_TIM1_CH1          1U
#define AF_SERVO2_TIM1_CH2               1U
#define AF_LINE_SERVO2_TIM1_CH2          1U
#define AF_SERVO3_TIM1_CH3               1U
#define AF_LINE_SERVO3_TIM1_CH3          1U
#define AF_SERVO1_TIM1_CH4               1U
#define AF_LINE_SERVO1_TIM1_CH4          1U
#define AF_SWDIO                         0U
#define AF_LINE_SWDIO                    0U
#define AF_SWCLK                         0U
#define AF_LINE_SWCLK                    0U
#define AF_MPULS3_TIM3_CH3               2U
#define AF_LINE_MPULS3_TIM3_CH3          2U
#define AF_MPULS4_TIM3_CH4               2U
#define AF_LINE_MPULS4_TIM3_CH4          2U
#define AF_SWO                           0U
...
#define AF_MPULS1_TIM2_CH3               1U
#define AF_LINE_MPULS1_TIM2_CH3          1U
#define AF_MPULS2_TIM2_CH4               1U
#define AF_LINE_MPULS2_TIM2_CH4          1U
...
#define AF_SERVO6_TIM4_CH3               2U
#define AF_LINE_SERVO6_TIM4_CH3          2U
#define AF_SERVO5_TIM4_CH4               2U
#define AF_LINE_SERVO5_TIM4_CH4          2U
