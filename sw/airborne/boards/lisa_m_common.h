 ...
 */
#if REMAP_UART1
#define UART1_GPIO_AF AFIO_MAPR_USART1_REMAP
#define UART1_GPIO_PORT_RX GPIO_BANK_USART1_RE_RX
#define UART1_GPIO_RX GPIO_USART1_RE_RX
#define UART1_GPIO_PORT_TX GPIO_BANK_USART1_RE_TX
#define UART1_GPIO_TX GPIO_USART1_RE_TX
#else
