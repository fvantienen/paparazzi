...
$(TARGET).CXXFLAGS += $(ROTORCRAFT_INC)
$(TARGET).CXXFLAGS += -DBOARD_CONFIG=$(BOARD_CFG)
$(TARGET).CXXFLAGS += -DPERIPHERALS_AUTO_INIT
$(TARGET).srcs   += mcu.c
...
$(TARGET).CXXFLAGS += -DPERIODIC_FREQUENCY=$(PERIODIC_FREQUENCY)
